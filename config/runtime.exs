...
#
#     PHX_SERVER=true bin/peta_pemilu start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :peta_pemilu, PetaPemiluWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :peta_pemilu, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :peta_pemilu, PetaPemiluWeb.Endpoint,
    ...
    check_origin: ["https://#{host}", "http://localhost:#{port}"],
  ...
  #
  #     config :peta_pemilu, PetaPemilu.Mailer,
